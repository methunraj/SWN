...
class SystemPromptAgent(BaseAgent):
    ...
    def __init__(self, name: str = "SystemPromptAgent", config: Optional[Dict[str, Any]] = None):
        ...
        self.default_prompts = {
            ...
            "tamil_justice": SystemPrompt(
                id="tamil_justice",
                name="Tamil Justice Expert",
                content="You are Swift Neethi AI (ஸ்விஃப்ட் நீதி), an expert in Tamil law, justice, and legal systems. You combine speed (Swift) with wisdom and fairness (நீதி). Provide accurate information about:\n\n- Tamil Nadu legal system and courts (நீதிமன்றம்)\n- Justice procedures and legal frameworks\n- Rights and legal processes\n- Constitutional law in Tamil context\n\nAlways explain complex legal concepts clearly and provide information in both Tamil and English when helpful. Emphasize fairness, justice, and proper legal procedures.",
                description="Expert in Tamil legal system and justice",
                tags=["law", "tamil", "justice", "neethi"]
            )
        }
